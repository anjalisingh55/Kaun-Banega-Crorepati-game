...
//             rs1.next();
        ...
        String ans=rs.getString("ans");
            ...
            out.println("<center><input type='submit' class='heighttext1' name='t1' value='"+s2+"' id='btn1' onclick='demo()'> <h1 style='color:white';></h1></button></center>");
            String s3 = rs.getString("o2");
            out.println("<center><input type='submit' class='heighttext2' name='t1' value='"+s3+"' id='btn2' onclick='clickCheckColor(this)'> <h1 style='color: white';></h1></button></center>");
            String s4 = rs.getString("o3");
            out.println("<center><input type='submit' class='heighttext3' name='t1' value='"+s4+"' id='btn3' onclick='clickCheckColor(this)'> <h1 style='color:white';></h1></button></center>");
            String s5 = rs.getString("o4");
            out.println("<center><input type='submit' class='heighttext4' name='t1' value='"+s5+"' id='btn4' onclick='clickCheckColor(this)'> <h1 style='color:white';></h1></button></center>");
            String amount=rs.getString("amount");
            y1++;
       %>
       <!--onclick='clickCheckColor(this)'-->
        </form>
 ...
 <form action="winner.jsp"><input type ="submit" class="lifeline" value = "Quit" style="left: 28px; top: 48px"></form>
         ...
         <form><input type="button" class="lifeline" id="b2"  onclick="lifeLine2()" value="50-50" style="left: 636px; top: 50px"></form>
          <form action="questions.jsp"><input type="submit"  class="lifeline" style="left: 780px; top: 48px" name="flip" value="2x"></form>
          <form><input type="button" class="lifeline"  onclick="openPopup()" style="left: 502px; top: 48px" value="Expert"></form>
         ...
         <h2>Expert Advice</h2>
           <p>Expert thinks it to be: <%=ans%></p>
